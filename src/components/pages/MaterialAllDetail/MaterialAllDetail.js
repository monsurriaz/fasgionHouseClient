...
import './MaterialAllDetail.css'
import fakeData4 from '../../fakeData/goodsInfo'
import NavBar from '../NavBar/NavBar';
import Footer from '../Footer/Footer';

const MaterialAllDetail = () => {
    const { thingsKey } = useParams();
    const things = fakeData4.find(pd => pd.key === thingsKey);
    const { name, price, image } = things;
    return (
        <div>
            <div className="color">
                <NavBar></NavBar>
...
export default MaterialAllDetail;